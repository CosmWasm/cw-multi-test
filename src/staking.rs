...
mod test {
    ...
    impl TestEnv {
        fn setup(validator1: (u64, u64, u64), validator2: (u64, u64, u64)) -> TestTuple {
    ...
    mod msg {
        ...
        #[test]
        fn query_staking() {
            let mut env = TestEnv::wrap(TestEnv::setup((10, 100, 1), (0, 1, 1)));
        ...
        fn rewards_initial_wait() {
            let mut env = TestEnv::wrap(TestEnv::setup((0, 100, 1), (10, 100, 1)));
