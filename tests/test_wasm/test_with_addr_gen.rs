...
use cw_multi_test::{no_init, AddressGenerator, AppBuilder, Executor, IntoAddr, WasmKeeper};
...
fn custom_address_generator_should_work() {
    ...
    assert_eq!(contract_addr.as_str(), "test_address".into_addr().as_str());
}
